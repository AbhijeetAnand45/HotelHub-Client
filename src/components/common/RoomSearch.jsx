...
const RoomSearch = ({ handleSearchResult }) => {
  ...
  /**This is going to be used to fetch avaailabe rooms from database based on search data that'll be passed in */
  const handleInternalSearch = async () => {
    ...
    try {
      // Convert startDate to the desired format (yyyy-mm-dd)
